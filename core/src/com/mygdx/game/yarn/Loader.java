...
import com.mygdx.game.yarn.Lexer.Regex;
import com.mygdx.game.yarn.Lexer.Token;
import com.mygdx.game.yarn.Lexer.TokenList;
import com.mygdx.game.yarn.Lexer.TokeniserException;
import com.mygdx.game.yarn.Loader.NodeInfo.Position;
import com.mygdx.game.yarn.Parser.Node;
...
public class Loader {
	...
	protected NodeInfo[] getNodesFromText(String text, NodeFormat format) {
		Array<NodeInfo> nodes = new Array<NodeInfo>();
		...
		case Json:
			...
			Json json = new Json();
			try {
				nodes = json.fromJson(Array.class, NodeInfo.class, text);
			} catch (Exception e) {
