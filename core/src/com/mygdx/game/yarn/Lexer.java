...
public class Lexer {
	...
	private void createStates() {
		ObjectMap<TokenType, String> patterns = new ObjectMap<TokenType, String>();
		...
		states = new ObjectMap<String, LexerState>();
	...
	public TokenList tokenise(String text) {
		...
		//setup
		indentation_stack = new Array<IntBoolPair>();
	...
	protected class LexerState {
		...
		public LexerState(ObjectMap<TokenType, String> patterns) {
			...
			token_rules = new Array<TokenRule>();
