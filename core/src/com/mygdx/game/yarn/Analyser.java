...
import com.mygdx.game.yarn.Analyser.Diagnosis.Severity;
import com.mygdx.game.yarn.Program.Instruction;
...
public class Analyser {
	...
	public static class Context {
		...
		public Iterable<Diagnosis> finalAnalysis(){
			Array<Diagnosis> diagnoses = new Array<Diagnosis>();
			for (CompiledProgramAnalyser a : analysers) {
